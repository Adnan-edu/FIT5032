...
namespace FIT5032AssignmentPortfo.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,RoomName,RoomDescription,HotelId")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,RoomName,RoomDescription,HotelId")] Room room)
        {
            if (ModelState.IsValid)
            {
