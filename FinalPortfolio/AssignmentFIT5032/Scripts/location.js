...
*/
const TOKEN = "pk.eyJ1IjoiYWRuYW4tY3MiLCJhIjoiY2sxM2MzZ3g4MDcyMTNqcDQ1Z2ZmNWY3YyJ9.h5RVN3mlT9oLCoEoK08GVw";
var locations = [];
...
map.on('load', function () {
    ...
    document.getElementById('geocoder').appendChild(geolocatecontrol.onAdd(map));
